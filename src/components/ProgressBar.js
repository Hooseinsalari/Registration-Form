...
const ProgressBar = ({ step }) => {
  ...
  return (
    <div className="relative flex items-center justify-between my-12 before:w-11/12 before:h-1 before:bg-gray-300 before:absolute before:top-1/2">
      <div
        className={`absolute bg-blue-700 w-${progressNum} h-1 rounded-md top-1/2 ease-in-out duration-500`}
      ></div>
      ...
      <div
        ...
        } ease-in-out duration-300 relative w-10 h-10 rounded-full flex items-center justify-center`}
      >
